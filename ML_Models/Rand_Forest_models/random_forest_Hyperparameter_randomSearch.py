...
try:
    ...
    # Optional: print(data.head()), data.info()
...
param_grid = {
    'n_estimators': [50, 100, 200, 300, 500], # Reduziert für schnelleres Beispiel
    'max_depth': [5, 10, 15, 20, 30, None],
    'min_samples_split': [2, 5, 10, 15], # Hinzugefügt
    'min_samples_leaf': [1, 3, 5, 7],   # Hinzugefügt
    'max_features': ['sqrt', None], # Kann hinzugefügt werden
    'criterion': ['gini', 'entropy'] # Kann hinzugefügt werden
}

# Basis-Modell
rf_base = RandomForestClassifier(random_state=42, class_weight='balanced')

# randomsearch initialisieren
